...
import astropy
from astropy.coordinates import solar_system_ephemeris, AltAz
...
def solar_system_full(time_now, loc):
...
def custom_bodies(update_time, loc, bodies_to_compute):
	time_now, time_str = update_time()
